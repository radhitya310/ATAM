                    ...
                    <div class="form-group">
                        ...
                        <select name="age" id="age" class="form-control form-select cursorClass" onchange="postName.submit()" autofocus>
                            ...
                            @else
                                @foreach ($age as $ages)
                                    @if ($ages->age_id == $search3)
                                        @if ($ages->age_id == 1)
                                            <option hidden value="{{ $search3 }}" id="">{{ $ages->age_category.' (0 - 6 Bulan)' }}</option>
                                        @endif
                                        @if ($ages->age_id == 2)
                                            <option hidden value="{{ $search3 }}" id="">{{ $ages->age_category.' (7 Bulan - 2 Tahun)' }}</option>
                                        @endif
                                        @if ($ages->age_id == 3)
                                            <option hidden value="{{ $search3 }}" id="">{{ $ages->age_category.' (3 - 11 Tahun)' }}</option>
                                        @endif
                                        @if ($ages->age_id == 4)
                                            <option hidden value="{{ $search3 }}" id="">{{ $ages->age_category.' ( > 11 Tahun)' }}</option>
                                        @endif
                                    @endif
                                @endforeach
                            @endif
                            @foreach ($age as $ages)
                                @if ($ages->age_id != $search3)
                                    @if ($ages->age_id == 1)
                                        <option value="{{ $ages->age_id }}" id="">{{ $ages->age_category.' (0 - 6 Bulan)' }}</option>
                                    @endif
                                    @if ($ages->age_id == 2)
                                        <option value="{{ $ages->age_id }}" id="">{{ $ages->age_category.' (7 Bulan - 2 Tahun)' }}</option>
                                    @endif
                                    @if ($ages->age_id == 3)
                                        <option value="{{ $ages->age_id }}" id="">{{ $ages->age_category.' (3 - 11 Tahun)' }}</option>
                                    @endif
                                    @if ($ages->age_id == 4)
                                        <option value="{{ $ages->age_id }}" id="">{{ $ages->age_category.' ( > 11 Tahun)' }}</option>
                                    @endif
                                @endif
                            @endforeach
                        </select>
                                            ...
                                            @foreach ($pet1 as $pets1)
                                                ...
                                                @endif
                                                        <table class="isi_tbl tbl_active_markAsAdopted text-left">
                                                            ...
                                                            <tr>
                                                                <td colspan="3">
                                                                    <div class="text-center btnUploadRecords">
                                                                        <a data-bs-toggle="offcanvas" href="#offcanvasExampleRecords{{ $pets1->adopt_submission_id }}" aria-controls="offcanvasExampleRecords" class="">
                                                                            Upload Track Records &raquo;
                                                                        </a>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                ...
                                                <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExampleRecords{{ $pets1->adopt_submission_id }}" aria-labelledby="offcanvasExampleRecordsLabel">
                                                    <div class="offcanvas-header bg-info">
                                                        <h5 class="offcanvas-title" id="offcanvasExampleRecordsLabel">{{__('Upload Track Records Pet')}}</h5>
                                                    ...
                                                    <div class="offcanvas-body">
                                                        ...
                                                        <form method="post" action="/upload-records-pet/proses" enctype="multipart/form-data">
                                                            @csrf
                                                            <input type="number" name="adoptSubmissionsID" id="" value="{{ $pets1->adopt_submission_id }}" hidden>
                                                            <div class="form-group pb-2">
                                                                <label for="uploadFoto">{{ __('Upload Photo *') }}</label>
                                                                <input name="uploadFoto" type="file" class="form-control @error('uploadFoto') is-invalid @enderror" id="uploadFoto" autofocus required>
                                                                <span style="font-size: 10px; color: grey">Format file harus .jpg,.jpeg,.png | Ukuran file maksimal 1024 kilobyte</span>
                                                                @error('uploadFoto')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="keterangan" id="keterangan" class="shadow form-control @error('keterangan') is-invalid @enderror" cols="30" rows="4" placeholder="Keterangan.." required></textarea>
                                                                <span style="font-size: 10px; color: grey">Maksimal 255 karakter</span>
                                                                @error('keterangan')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
